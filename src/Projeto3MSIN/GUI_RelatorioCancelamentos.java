...
public class GUI_RelatorioCancelamentos extends JInternalFrame {
	...
	public GUI_RelatorioCancelamentos() {
	...
	public void inicializarComponentes() {
		...
		setTitle(GUI_Idioma.bn.getString("Menu.TituloRelatorioMC"));
	...
	public void definirEventos() {
		Bgerar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (TO_Matricula a : MatriculaDAO.consultarDataC(data)) {
